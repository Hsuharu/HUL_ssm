...
//  TFile *file = new TFile("../../rootfile/BH1_1M_clusterkai.root");
  ...
  hist[2] = new TH1D("BH1 or_Trigger(1/10000) & mask","",301000,-10,3000);
  hist[3] = new TH1D("BH1 or_Trigger(1/10000) & mask false","",301000,-10,3000);
...
//                        cout << trigger <<""<< endl; 
                        if(trigger>0.9999){
                                ...
                                pre2_ms_time = ms_time;

                                if(delta_t<0.1){
                                        continue;
                                }
                                pre_ms_time = ms_time;
//                               cout << pre_ms_time << "" << endl;
                        }//else{
                }
        }
