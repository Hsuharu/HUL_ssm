void ratio_16M_cluster(){
  TFile *file = new TFile("../../../rootfile/BH1_16M_cluster.root");
...
// file.dat out --------------------------------------------------------------        
  TString fout1 = ("../DAT/maximum_16M_cluster.dat");
  ofstream fout_1(fout1.Data());
  TString fout2 = ("../DAT/average_16M_cluster.dat");
  ofstream fout_2(fout2.Data());
  TString fout3 = ("../DAT/ratio_16M_cluster.dat");
