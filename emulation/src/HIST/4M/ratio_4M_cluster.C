void ratio_4M_cluster(){
  TFile *file = new TFile("../../../rootfile/BH1_4M_cluster.root");
...
// file.dat out --------------------------------------------------------------        
  TString fout1 = ("../DAT/maximum_4M_cluster.dat");
  ofstream fout_1(fout1.Data());
  TString fout2 = ("../DAT/average_4M_cluster.dat");
  ofstream fout_2(fout2.Data());
  TString fout3 = ("../DAT/ratio_4M_cluster.dat");
...
//      fout_3 << diff[i] << endl;
  ...
  TH1 *frame = gPad->DrawFrame(0,0,12,55,"Ratio");
         gPad->SetGrid();
