void ratio_14M_cluster(){
  TFile *file = new TFile("../../../rootfile/BH1_14M_cluster.root");
...
// file.dat out --------------------------------------------------------------        
  TString fout1 = ("../DAT/maximum_14M_cluster.dat");
  ofstream fout_1(fout1.Data());
  TString fout2 = ("../DAT/average_14M_cluster.dat");
  ofstream fout_2(fout2.Data());
  TString fout3 = ("../DAT/ratio_14M_cluster.dat");
...
//      fout_3 << diff[i] << endl;
  ...
  TH1 *frame = gPad->DrawFrame(0,0,12,35,"Ratio");
         gPad->SetGrid();
