void ratio_20M_clusterkai(){
  TFile *file = new TFile("../../../rootfile/BH1_20M_clusterkai.root");
...
// file.dat out --------------------------------------------------------------        
  TString fout1 = ("maximum_20M_clusterkai.dat");
  ofstream fout_1(fout1.Data());
  TString fout2 = ("../DAT/average_20M_clusterkai.dat");
  ofstream fout_2(fout2.Data());
  TString fout3 = ("../DAT/ratio_20M_clusterkai.dat");
...
//        ch_max->Draw();
 ...
 c1->Print("spillstructure_clusterkai.pdf");
 c2->Print("ratio_distribution_clusterkai.pdf");
